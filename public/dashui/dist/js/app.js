        ...
        ManageThemeBackground: function() {
            ...
            function setlogobg() {
                ...
                if (lbg != undefined && lbg != "") {
                    ...
                    $('#' + myid + ' .topbar nav .nav-wrapper .brand-logo').attr("data-logobg", "skin6");
                }
            };
            setlogobg();
            ...
            function setnavbarbg() {
                ...
                if (nbg != undefined && nbg != "") {
                    ...
                    $('#' + myid + ' .topbar nav').attr("data-navbarbg", "skin6");
                    $('#' + myid).attr("data-navbarbg", "skin6");
                }
            };
            setnavbarbg();
        ...
        ManageSidebarColor: function() {
            ...
            function setsidebarbg() {
                ...
                if (sbg != undefined && sbg != "") {
                    ...
                    $('#' + myid + ' .left-sidebar .sidenav').attr("data-sidebarbg", "skin6");
                }
            };
            setsidebarbg();
