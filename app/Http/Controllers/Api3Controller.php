                ...
                foreach($projects as $project){
                    ...
                    // using carbon to make date readable
                       ...
                       if ($project_progress == 2) {
                        ...
                        ->select('project_bids.id as bid_id', 'project_bids.user_id as pro_id',  'project_bids.bid_message', 'project_bids.bid_amount', 'users.image as profile_photo', 'project_bids.bid_status')
