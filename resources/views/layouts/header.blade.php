    ...
    <div class="header-widget">
        <a href="/login" class="log-in-button"><i class="icon-material-outline-account-circle"></i> <span>Log In / Register</span></a>
    </div>
    @endguest
          ...
          <div class="header-widget hide-on-mobile">
                ...
                <div class="header-notifications">
                    ...
                    <div class="header-notifications-dropdown">
                        ...
                        <a href="{{route('customer_inbox')}}" class="header-notifications-button ripple-effect button-sliding-icon">View All Messages<i class="icon-material-outline-arrow-right-alt"></i></a>
                    </div>
                </div> 
                            ...
                            <div class="user-details">
                                 @if (Auth::user()->image == null)
                                    ...
                                    <div class="user-avatar status-online"><img src="{{ url('/'). env('PROFILE_IMAGES_PATH').Auth::user()->image}}" alt=""></div>
                                        ...
                                        @endif                                <div class="user-name">
                                        {{ Auth::user()->first_name }} {{ Auth::user()->last_name }}
                                        @if ( Auth::user()->user_role == 'customer')
                                                <span>Customer</span> 
                                        @endif
                                        @if ( Auth::user()->user_role == 'pros')
