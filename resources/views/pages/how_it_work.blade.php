  ...
  <div class="container padding-top-65">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-8 col-sm-12">
        ...
        <a href="{{route('register_pro')}}" class="button  ripple-effect big  margin-top-20">Start Earning <i class="icon-material-outline-arrow-right-alt"></i></a>
    </div>
    <br>
    <div class="col-xl-4 htw_c_1">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 offset-md-3">
          ...
          <a href="{{route('register_pro')}}" class="button  ripple-effect big  margin-top-20">Browse Jobs</a>
          </div>
        </div>
      </div>
