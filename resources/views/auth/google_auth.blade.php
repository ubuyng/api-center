...
<div class="container margin-top-65 margin-bottom-25">
    ...
    <div class="row">
            ...
            <div class="col-xl-8 offset-xl-2">
                <h2 class="margin-bottom-10"><strong>Connect your Google account to Ubuy</strong></h2>
            ...
            @endif
                ...
                <input type="hidden" name="google_token"  @if (isset($_GET['google_token']))
                value="{{$_GET['google_token']}}"
                @endif >
