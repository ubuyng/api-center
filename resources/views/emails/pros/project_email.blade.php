...
<p style="font-size: 12px; line-height: 16px; text-align: right; margin: 0;"><span style="font-size: 14px;">Synchronizing Services</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
...
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><img align="center" alt="Image" border="0" class="center autowidth fullwidth" src="https://ubuy.ng/mvp_ui/email_images/email_project_alert.png" style="outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; clear: both; border: 0; height: auto; float: none; width: 100%; max-width: 700px; display: block;" title="Image" width="700"/>
<!--[if mso]></td></tr></table><![endif]-->
</div>
<!--[if (!mso)&(!IE)]><!-->
</div>
...
<p style="font-size: 14px; line-height: 45px; text-align: center; margin: 0;"><span style="font-size: 38px;"><strong><span style="line-height: 45px; font-size: 38px;"><span style="line-height: 45px; font-size: 38px;">{{$project->cus_name}} is looking for {{$project->sub_category_name}}</span></span></strong></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
...
<div style="background-color:#F4F4F4;">
	<div class="block-grid" style="Margin: 0 auto; min-width: 320px; max-width: 700px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; padding-bottom: 25px;;">
	...
	<p style="font-size: 12px; line-height: 28px; margin: 0; text-align:center;"><span style="font-size: 16px;">Location: <strong>{{$project->city}} - {{$project->state}}</strong>.</span></p>
	<p style="font-size: 12px; line-height: 28px; margin: 0; text-align:center;"><span style="font-size: 16px;"> <strong> Contact {{$project->cus_name}} first.  Always keep your profile updated to get more leads.</strong></span></p>
...
<div style="color:#555555;font-family:'Open Sans', Helvetica, Arial, sans-serif;line-height:180%;padding-top:15px;padding-right:20px;padding-bottom:30px;padding-left:30px;">
<div style="line-height: 21px; font-size: 12px; font-family: 'Open Sans', Helvetica, Arial, sans-serif; color: #555555;">
	<p style="font-size: 12px; line-height: 28px; margin: 0; text-align:center;"><span style="font-size: 16px;"><strong>Customer's requests</strong>.</span></p>
	<hr>
	<p style="font-size: 12px; line-height: 28px; margin: 0;"><span style="font-size: 16px;"> <strong>Project Brief</strong></span></p>  
	@if ($project->project_message == null)
	<p style="font-size: 12px; line-height: 28px; margin: 0;"><span style="font-size: 16px;"> No special breif </span></p>  
	@else
		
	<p style="font-size: 12px; line-height: 28px; margin: 0;"><span style="font-size: 16px;">{{$user->project_message}}</span></p>
	@endif
	@foreach ($details as $detail) 
<hr>
<p style="font-size: 12px; line-height: 28px; margin: 0;"><span style="font-size: 16px;"> <strong>{{$detail->ques_text}}</strong></span></p>
<p style="font-size: 12px; line-height: 28px; margin: 0;"><span style="font-size: 16px;">{{$detail->choice_text}}</span></p>
@endforeach
...
<div style="background-color:#F4F4F4;">
<div class="block-grid two-up" style="Margin: 0 auto; min-width: 320px; max-width: 700px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; background-color: transparent;;">
<div style="border-collapse: collapse;display: table;width: 100%;background-color:transparent;">
<!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#F4F4F4;"><tr><td align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:700px"><tr class="layout-full-width" style="background-color:transparent"><![endif]-->
<!--[if (mso)|(IE)]><td align="center" width="350" style="background-color:transparent;width:350px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;" valign="top"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 0px; padding-left: 0px; padding-top:5px; padding-bottom:5px;"><![endif]-->
<div class="col num6" style="min-width: 320px; max-width: 350px; display: table-cell; vertical-align: top;;">
...
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px" align="right"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:40.5pt; width:109.5pt; v-text-anchor:middle;" arcsize="8%" stroke="false" fillcolor="#1879be"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:'Trebuchet MS', Tahoma, sans-serif; font-size:22px"><![endif]-->
<div style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#1879be;border-radius:4px;-webkit-border-radius:4px;-moz-border-radius:4px;width:auto; width:auto;;border-top:1px solid #1879be;border-right:1px solid #1879be;border-bottom:1px solid #1879be;border-left:1px solid #1879be;padding-top:5px;padding-bottom:5px;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;"><span style="padding-left:20px;padding-right:20px;font-size:22px;display:inline-block;">
<span style="font-size: 16px; line-height: 32px;"><span style="font-size: 22px; line-height: 44px;">Send <span style="line-height: 44px; font-size: 22px;">Bid</span></span></span>
</span></div>
...
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px" align="left"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:40.5pt; width:190.5pt; v-text-anchor:middle;" arcsize="8%" stroke="false" fillcolor="#1879be"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:22px"><![endif]-->
<div style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#1879be;border-radius:4px;-webkit-border-radius:4px;-moz-border-radius:4px;width:auto; width:auto;;border-top:1px solid #1879be;border-right:1px solid #1879be;border-bottom:1px solid #1879be;border-left:1px solid #1879be;padding-top:5px;padding-bottom:5px;font-family:'Open Sans', Helvetica, Arial, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;"><span style="padding-left:20px;padding-right:20px;font-size:22px;display:inline-block;">
<span style="font-size: 16px; line-height: 32px;"><span style="font-size: 22px; line-height: 44px;">View More Requests</span></span>
</span></div>
<!--[if mso]></center></v:textbox></v:roundrect></td></tr></table><![endif]-->
</div>
<!--[if (!mso)&(!IE)]><!-->
...
<div style="color:#555555;font-family:'Open Sans', Helvetica, Arial, sans-serif;line-height:150%;padding-top:15px;padding-right:30px;padding-bottom:5px;padding-left:30px;">
	...
	<p style="font-size: 12px; line-height: 18px; text-align: center; margin: 0;"><strong>Do you need help getting started? Just reply this email! we're always here to help</strong></p>
	<p style="font-size: 12px; line-height: 18px; text-align: center; margin: 0;"><strong>Feel free to check out our frequently asked questions.</strong></p>
	</div>
	</div>
</div>
</div>
...
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; font-family: Arial, sans-serif"><![endif]-->
	<div style="color:#838383;font-family:'Open Sans', Helvetica, Arial, sans-serif;line-height:150%;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
		...
		<p style="font-size: 14px; line-height: 21px; text-align: center; margin: 0;"><strong><span style="font-size: 11px; line-height: 16px;">You received this email because you signed up on our website or made purchase from Ubuy. </span></strong></p>
		</div>
		</div>
<!--[if mso]></td></tr></table><![endif]-->
